...
Here we provide the data files of the cross sections for different neutrino flavor and different nucleus targets. More data files will be uploaded later.   
